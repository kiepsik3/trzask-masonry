        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-10 offset-lg-1 col-xl-8 offset-xl-2">
              ...
              <Paragraph>
                Trzask jest profesjonalnym studiem animacji specjalizującym się
                w reklamie internetowej. Zajmujemy się wszystkim, co jest z nią
                związane - tworzymy interaktywne{" "}
          ...
          <div className="row">
            ...
            <div className="col-lg-4 offset-lg-1 col-md-6 text-centered">
              <Paragraph>
                ...
                Motoryzacji, Bankowości, Telekomunikacji, Elektroniki i Gamingu.
                Ten ostatni jest nam szczególnie bliski, ponieważ jesteśmy
                graczami i świetnie rozumiemy świat tej grupy docelowej.
              </Paragraph>
            </div>
          </div>
          <div className="row">
            ...
            <div className="col-md-6 offset-lg-1 img-with-text">
              ...
              <div className="row">
                <div className="col-lg-8 col-md-12">
                  <Paragraph>
                    Od ponad 14 lat działamy z największymi markami nie tylko w
                    Polsce, ale i na świecie. Efekty naszej pracy można zobaczyć
                    w Stanach Zjednoczonych, Holandii, Belgii czy Zjednoczonych
                    Emiratach Arabskich.
                  </Paragraph>
                </div>
              </div>
